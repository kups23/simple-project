  ...
  return (
    <main className="p-4 flex flex-col ">
      ...
      <div className="text-gray-400 mb-3">
        <Stack  spacing={{ xs: 0.5, sm: 1, md: 2 }}     // responsive spacing
    sx={{
      '& .MuiBreadcrumbs-ol': {
        display: 'flex',
...
{/* profile and experience section */}
<div className='bg-[#f9f9f9] gap-10 px-4 py-7 flex flex-col'>

  {/* Profile and Quick Action Section */}
  <div className='flex flex-col md:flex-row w-full mb-4 justify-start gap-6 md:gap-10'>

    {/* Profile Information */}
    <div className='w-full md:basis-1/2 flex flex-col'>
      <div className='flex flex-col sm:flex-row mb-6 gap-4 items-start sm:items-center'>
      ...
      <div className='flex flex-col gap-4'>
        <span className='text-black font-bold'>Personal Information</span>
        <Stack direction="row" spacing={1} className="flex-wrap gap-2">
          {userDetails.stacks.map((stack:any)=> <Chip label={stack} key={stack} />)}
        </Stack>
      </div>
    </div>

    {/* Quick Action Section */}
    <div className='w-full md:basis-1/2 flex flex-col gap-3'>
  ...
  <div className='flex flex-col'>
    ...
    {userDetails.experience.map((exp: any) => 
      <div className='border-l border-gray-300 mb-4 px-2 flex flex-col' key={exp.title}>
